/*
This is a simple program that helps identify the I2C address of any device connected to 
SDA - GPIO 21
SCL - GPIO 22
*/
#include <stdio.h>
...
void check_address_task(void *arg){
    ...
    while(1){
        esp_err_t err;
        //using i2c master probe on a for loop going through all available address
        for(uint8_t i = 3; i < 0x68; i++){
